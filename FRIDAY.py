...
def sendEmail(receiver_mail, message):
    ...
    server.ehlo()
    server.starttls()
    server.login('neel.majumder005@gmail.com', 'your_password')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            webbrowser.open_new("https://theheritageschooll-my.sharepoint.com/personal/suvajit_majumder_theheritageschool_ind_in/_layouts/15/onedrive.aspx")

        elif 'open hoichoi' in query:
            webbrowser.open_new("https://www.hoichoi.tv/")
            ...
            if hours <= 12:
                ...
                pyttsx3.init().say("The time is " + str(hours) + str(minutes) + "am")
            else:
                hours -= 12
                ns += str(hours) + ":" + str(minutes) + " p.m."
                pyttsx3.init().say("The time is " + str(hours) + str(minutes) + "pm")
            print(ns)
